# ISA-Tab example assessment evidence

This package contains one illustrative ISA Investigation, Study, and Assay plus
two synthetic measurements. It was created to demonstrate FAIR.md v0.3 domain
profiling.
...
- No DOI, repository deposit, preservation policy, external ISA API validation,
  or ISA community endorsement is claimed.

Until an ISA validator report is generated, the profile status remains
`aligned`, not `adopted`.
